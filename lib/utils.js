...
function checkThresholdForStream(inStream, threshold, fileTooSmall, fileLargeEnough) {
	...
	inStream.pipe(
		through2(
			...
			function() {
				...
				// Need a new stream to return since we already read the contents of inStream
